...
const ALL_TOOLS: Tool[] = [
  ...
  // ── Remaining Utils ──
  { name: 'Time Tracker',      slug: 'time-tracker',      icon: 'Timer',           description: 'Track mandatory work hours from clock-in, split office/home time, or calculate durations', category: 'Utils', keywords: ['time', 'duration', 'hours', 'timesheet', 'clock', 'timer', 'work', 'office', 'shift', 'attendance', 'end time'] },
  ...
  { name: 'Screen Mirror',     slug: 'screen-mirror',     icon: 'Smartphone',      description: 'Mirror and control an Android device over USB (desktop app)', category: 'Media', keywords: ['mirror', 'screen', 'android', 'scrcpy', 'adb', 'cast', 'phone', 'device', 'control', 'vysor', 'desktop'], desktopOnly: true },
