...
export const tools: Tool[] = [
  ...
  { name: 'Hash Generator',    slug: 'hash-generator',    icon: 'Fingerprint',     description: 'Generate SHA-1, SHA-256, SHA-512 hashes',                   category: 'Security', keywords: ['sha', 'md5', 'checksum', 'digest', 'crypto'] },
  ...
  { name: 'YAML ↔ JSON',       slug: 'yaml-json',         icon: 'FileJson',        description: 'Convert between YAML and JSON — great for KBs and CI/CD', category: 'Data', keywords: ['yml', 'config', 'k8s', 'kubernetes', 'docker', 'ci'] },
