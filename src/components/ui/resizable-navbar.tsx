...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      // change `sticky` to `fixed` if you want the navbar pinned to the viewport
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <img
        src="/AppIconDarkTheme.png"
        alt="DevToolbox"
        width={30}
        height={30}
      />
      <span className="font-medium text-black dark:text-white">DevToolbox</span>
    </a>
  )
}
